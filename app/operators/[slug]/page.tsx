    ...
    <main style={{ minHeight: '100vh', background: '#1a1d24', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <div style={{ background: '#242830', borderRadius: '12px', padding: '2rem', margin: '1.5rem 0', border: '1px solid #2a2d35' }}>
          ...
          {!operator?.is_claimed && <a href={`/claim?operator=${operator?.id}`} style={{ display: "block", textAlign: "center", marginTop: "0.75rem", padding: "0.65rem", background: "transparent", color: "#6b7280", borderRadius: "6px", textDecoration: "none", fontSize: "0.8rem", border: "1px solid #2a2d35" }}>✈ Are you this operator? Claim this page to edit your profile</a>}
        </div>
