    ...
    <main style={{ minHeight: '100vh', background: '#1a1d24', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <div style={{ background: '#242830', borderRadius: '12px', padding: '2rem', margin: '1.5rem 0', border: '1px solid #2a2d35' }}>
          ...
          <a href={`/review?operator=${encodeURIComponent(operator?.name || '')}`}
            style={{ display: 'block', textAlign: 'center', marginTop: '1.5rem', padding: '0.85rem', background: '#f0c040', color: '#1a1d24', borderRadius: '6px', textDecoration: 'none', fontWeight: 700, fontSize: '0.95rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        ...
        {reviews.length === 0 ? (
          <div style={{ background: '#242830', borderRadius: '12px', padding: '3rem', textAlign: 'center', border: '1px solid #2a2d35' }}>
            ...
            <a href={`/review?operator=${encodeURIComponent(operator?.name || '')}`}
              style={{ padding: '0.75rem 2rem', background: '#1a1d24', color: '#f0c040', border: '1px solid #f0c040', borderRadius: '6px', textDecoration: 'none', fontWeight: 700 }}>
              Write a Review
            </a>
          </div>
        ) : (
